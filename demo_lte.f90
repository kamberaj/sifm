!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!
! Id: demo_lte.f90,v 1.0 19-03-2018, IBU
!
...
!
      USE sifm_kinds
      use LTE_CLASS, only : LTE_DRIVER, LSTE_DRIVER
      implicit none
!
...
! 
      IF (qTEMethod == 1) THEN
          CALL LSTE_DRIVER(Nframes, Ndim, Natoms,qteShuffle, qteNorm, debug, Nshuffles, Rcut, StatP)
      ELSE
          CALL LTE_DRIVER(Nframes, Ndim, Natoms, qteShuffle, qteNorm, debug, Nshuffles, Rcut, StatP)      
      ENDIF
!
